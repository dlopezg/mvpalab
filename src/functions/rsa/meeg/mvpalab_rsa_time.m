...
for sub = 1 : nsub
    ...
    %%  Select datamatrix:
    %   Select subject data, labels and timepoints.
    ...
    %  rdms - [conditions x conditions x timepoints]

    rdms{sub} = mvpalab_rdm(cfg,X,Y);
    ...
    vrdms{sub} = mvpalab_vectorizerdm(cfg,rdms{sub}.rdm);
